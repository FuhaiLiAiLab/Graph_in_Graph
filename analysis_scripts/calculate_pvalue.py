...
def calculate_pvalues(group_one, group_two, upstream_file):
    ...
    if not results_df.empty:
        ...
        results_df['q_value_BH'] = q_values
    return results_df

def process_files(label_file, upstream_files, regions, output_folder):
    # Separate the groups
    t_group, pre_group, no_group = separate_patient_groups(label_file)
...
label_file = './data/filtered_data/label_phenodata_onehot_nodeidx_df.csv'
...
process_files(label_file, upstream_files, regions, output_folder)
